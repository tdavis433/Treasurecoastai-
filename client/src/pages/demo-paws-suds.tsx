      ...
      <div 
        ...
        style={{
          background: `
            ...
            radial-gradient(ellipse 60% 40% at 20% 80%, rgba(6, 182, 212, 0.04) 0%, transparent 40%)
          `,
...
export default function DemoPawsSuds() {
  ...
  useEffect(() => {
    ...
    script.async = true;
    script.dataset.clientId = "demo_paws_suds_grooming_demo";
    script.dataset.botId = "demo_paws_suds_grooming_demo_assistant";
    script.dataset.theme = "dark";
    script.dataset.primaryColor = "#06B6D4";
    script.dataset.greeting = "Hi there! I'm the Paws & Suds assistant. I can help you book grooming appointments, answer questions about our services, and make sure your furry friend gets the pampering they deserve. How can I help you today?";
    script.dataset.showGreetingPopup = "true";
    script.dataset.greetingTitle = "Paws & Suds Assistant";
    script.dataset.greetingMessage = "Hi there! I'm the Paws & Suds assistant. I can help you book grooming appointments or answer questions about our services.";
    script.dataset.greetingDelay = "3";
    script.dataset.businessName = "Paws & Suds Assistant";
    script.dataset.businessSubtitle = "Pet Grooming • Demo";
    script.dataset.bubbleIcon = "heart";
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="text-center space-y-8">
          ...
          >
            ...
            <div className="space-y-6 relative">
              <Badge className="bg-cyan-500/10 text-cyan-400 border-cyan-400/25 shadow-[0_0_20px_rgba(6,182,212,0.1)]">
                <Sparkles className="h-3 w-3 mr-1" style={{ filter: 'drop-shadow(0 0 4px rgba(6,182,212,0.5))' }} />
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold" style={{ lineHeight: 1.2 }}>
                <span 
                  ...
                  style={{
                    backgroundImage: 'linear-gradient(135deg, #06B6D4 0%, #0891B2 25%, #5EEAD4 50%, #A78BFA 75%, #C4B5FD 100%)',
                    filter: 'drop-shadow(0 0 30px rgba(6, 182, 212, 0.3))',
                    WebkitBackgroundClip: 'text'
                  }}
                  data-testid="demo-title"
                >
                  Paws & Suds Pet Grooming
                </span>
                <span 
              ...
              <p className="text-base text-white/55 leading-relaxed max-w-2xl mx-auto" style={{ letterSpacing: '0.01em' }}>
                Paws & Suds is a premium pet grooming salon in Port St. Lucie.
                This is a <strong className="text-white/75">live AI assistant demo</strong> showing how 
                Treasure Coast AI handles appointment booking, pricing questions, and pet care inquiries.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {[
              { icon: CheckCircle2, color: '#06B6D4', text: '24/7 AI booking' },
              { icon: Heart, color: '#A855F7', text: 'Pet care expertise' },
              { icon: Star, color: '#22C55E', text: '5-star service' }
            ].map((item, i) => (
              <div 
                key={i}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-white/45 mt-1">
                  Click the <span className="text-cyan-400 font-medium" style={{ textShadow: '0 0 10px rgba(6,182,212,0.3)' }}>chat bubble</span> in the bottom-right corner to try the AI assistant!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <Button 
              size="lg" 
              className="relative overflow-hidden text-[#0A0A0F] font-semibold shadow-[0_0_30px_rgba(6,182,212,0.35)] hover:shadow-[0_0_40px_rgba(6,182,212,0.5)] transition-all duration-300 hover:-translate-y-0.5"
              style={{
        ...
        <div 
          ...
          style={{
            ...
            backgroundImage: 'linear-gradient(90deg, transparent, rgba(6, 182, 212, 0.1), transparent)',
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { 
                ...
                desc: 'Complete spa experience including bath, haircut, nail trim, ear cleaning, and finishing touches. Your pet will leave looking and feeling amazing.'
              },
              { 
                icon: Heart, 
                color: '#A855F7', 
                title: 'Bath & Brush',
                desc: 'A refreshing bath with premium shampoo and conditioner, followed by thorough brushing and blow-dry. Perfect for regular maintenance.'
              },
              { 
                icon: Star, 
                color: '#22C55E', 
                title: 'Specialty Services',
                desc: 'De-shedding treatments, teeth brushing, flea treatments, and creative grooming options. We cater to all your pet\'s unique needs.'
              }
            ].map((card, i) => (
              <Card 
                key={i}
        ...
        >
          <div 
            ...
            style={{
              background: 'linear-gradient(90deg, rgba(6, 182, 212, 0.03) 0%, rgba(168, 85, 247, 0.03) 50%, rgba(6, 182, 212, 0.03) 100%)'
            }}
          />
          ...
          <div className="text-center mb-8 relative">
            ...
            <h3 className="text-xl font-semibold text-white">AI-Powered Booking Experience</h3>
          </div>

          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 relative">
            {[
              { icon: MessageCircle, color: '#06B6D4', text: 'Chat with AI assistant' },
              { icon: ClipboardList, color: '#A855F7', text: 'Discuss your pet\'s needs' },
              { icon: Calendar, color: '#22C55E', text: 'Book appointment' },
              { icon: BarChart3, color: '#F59E0B', text: 'Confirmation sent' }
            ].map((step, i, arr) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-white/25">
              Demo featuring Paws & Suds Pet Grooming - Port St. Lucie, FL
            </p>
          </div>
        </div>
      </footer>
