...
const businessTypeIcons: Record<string, React.ReactNode> = {
  ...
  tattoo_studio: <Palette className="h-6 w-6" />,
...
const businessTypeColors: Record<string, { bg: string; text: string; border: string }> = {
  ...
  barber: { bg: "bg-purple-500/20", text: "text-purple-400", border: "border-purple-500/30" },
  ...
  gym: { bg: "bg-green-500/20", text: "text-green-400", border: "border-green-500/30" },
  ...
  tattoo_studio: { bg: "bg-indigo-500/20", text: "text-indigo-400", border: "border-indigo-500/30" },
  ...
  law_firm: { bg: "bg-blue-700/20", text: "text-blue-400", border: "border-blue-700/30" },
  dental_clinic: { bg: "bg-teal-500/20", text: "text-teal-400", border: "border-teal-500/30" },
  boutique_hotel: { bg: "bg-amber-700/20", text: "text-amber-300", border: "border-amber-700/30" },
  roofing: { bg: "bg-red-500/20", text: "text-red-400", border: "border-red-500/30" },
  wedding_venue: { bg: "bg-pink-600/20", text: "text-pink-300", border: "border-pink-600/30" },
