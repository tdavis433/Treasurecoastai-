 ...
 * 
 * Shows at top of client dashboard when super-admin is viewing as them
 * 
...
export function ImpersonationBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#00e5ff] to-[#00b8cc] text-black px-6 py-3 flex items-center justify-between">
