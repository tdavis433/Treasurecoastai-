 ...
 * 
 * Replaces complex 8-step wizard with simple 3-step process
 * 
                ...
                <div className="bg-white/5 rounded-lg p-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white font-semibold">{businessName}</div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="text-white font-semibold">{contactEmail}</div>
                    </div>
                    {contactPhone && (
                      <div>
                        <div className="text-white/60 text-sm mb-1">Phone</div>
                        <div className="text-white font-semibold">{contactPhone}</div>
                      </div>
                    )}
                    {notes && (
