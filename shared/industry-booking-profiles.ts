import {
  ...
  RECOVERY_HOUSING_REQUEST_CALLBACK,
  ...
  appointmentTypes: [
    {
      ...
      intakeFields: [
        ...
        { key: 'preferredDay', label: 'Preferred Day', required: true, type: 'select', options: PREFERRED_DAY_OPTIONS },
        { key: 'preferredTimeWindow', label: 'Preferred Time', required: true, type: 'select', options: PREFERRED_TIME_WINDOW_OPTIONS },
        { key: 'urgency', label: 'How urgent is this?', required: false, type: 'select', options: URGENCY_OPTIONS },
        { key: 'notes', label: 'Additional Notes', required: false, type: 'textarea', placeholder: 'Any additional information...' },
      ],
    ...
    },
    {
      ...
      intakeFields: [
        ...
        { key: 'whoFor', label: 'Who is this for?', required: true, type: 'select', options: WHO_FOR_OPTIONS },
        { key: 'preferredDay', label: 'Preferred Day', required: true, type: 'select', options: PREFERRED_DAY_OPTIONS },
        { key: 'preferredTimeWindow', label: 'Best Time to Call', required: true, type: 'select', options: PREFERRED_TIME_WINDOW_OPTIONS },
        { key: 'urgency', label: 'How urgent is this?', required: false, type: 'select', options: URGENCY_OPTIONS },
        { key: 'notes', label: 'Additional Notes', required: false, type: 'textarea', placeholder: 'Any additional information...' },
      ],
